...
{
	// inicjalizujemy wektor zmiennych służący nam do wygenerowania szumu, wszystkie zmienne
	// zawarte w wektorze mają wartość od 0 do 255 i każda z nich pojawia się tylko raz
	_permutation = {
	...
	// dublujemy wszystkie wartości (kolejność zostanie zachowana)
...
PerlinNoise::PerlinNoise(uint32_t seed)
{
	...
	// wypełniamy wektor wartościami od 0 do 255
	std::iota(_permutation.begin(), _permutation.end(), 0);

	// mieszamy wartości zależnie od podanego seed'a 
...
// praktycznie ctrl+c, ctrl+v z kodu javy
...
// tutaj niecodzienne ułożenie funkcji parametr t- waga występuje na początku!!
